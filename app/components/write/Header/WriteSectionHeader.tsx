const stepBadge =
  "flex items-center justify-center w-8 h-8 rounded-full bg-primary text-white text-sm font-bold";
    ...
    <div className="flex items-center justify-between mb-6">
      ...
      {tooltip && (
        <div className="group relative" title={tooltip}>
          ...
          <div className="absolute bottom-full right-0 mb-2 hidden group-hover:block w-72 p-3 bg-slate-900 text-white text-xs rounded shadow-lg z-10 leading-relaxed">
            {tooltip}
          </div>
        </div>
      )}
